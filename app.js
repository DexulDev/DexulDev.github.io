const languages = {
    en: {
        ...
        about: "About me",
        aboutText: "18-year-old Backend Web Developer, with work experience. I specialize in Laravel, although I'm recently learning .NET and ASP.NET. I'm focused on continuous learning to improve my skills and achieve my professional goals.",
...
While I am passionate about building structured and optimized solutions, I also value communication and teamwork. Listening to different perspectives and understanding each project's needs is a fundamental part of my approach because good software is not only measured by its code but by the impact it creates on those who use it.`,
    ...
    es: {
        ...
        about: "Sobre mí",
        aboutText: "Desarrollador Web Backend de 18 años, con experiencia laboral. Me especializo en Laravel, aunque recientemente estoy aprendiendo .NET y ASP.NET. Estoy enfocado en seguir aprendiendo para mejorar mis habilidades y alcanzar mis metas profesionales.",
